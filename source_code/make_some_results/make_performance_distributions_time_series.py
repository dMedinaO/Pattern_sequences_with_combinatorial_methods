...
for file in list_path:
	...
	for i in range(len(dataset)):
		try:
			array_data_calinkski.append(float(dataset['calinski_harabasz_score'][i]))
			array_data_siluetas.append(float(dataset['silhouette_score'][i]))
			array_dalvin.append(float(dataset['davies_bouldin_score'][i]))
		except:
			pass

make_histogram(array_data_siluetas, path_results+"histogram_for_siluetas_time_series.png", "Silhouette Index")
make_histogram(array_data_calinkski, path_results+"histogram_for_calinski_time_series.png", "Calinski-Harabasz Index")
make_histogram(array_dalvin, path_results+"histogram_for_dalvin_time_series.png", "Davies Bouldin Index")

...
#process summary
dict_summary = {"Total sequences": len(sequences_array_in)+len(sequences_array_not_in), "Sequences to process":len(sequences_array_in), "Ignored sequences":len(sequences_array_not_in)}

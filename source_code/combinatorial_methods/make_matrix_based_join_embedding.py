...
dataset = pd.read_csv(path_to_Data+"/clustering_correlation_distance.csv")	
array_datasets.append(dataset)
dataset = pd.read_csv(path_to_Data+"/clustering_cosine_distance.csv")	
array_datasets.append(dataset)
dataset = pd.read_csv(path_to_Data+"/clustering_mahalonobis_distance.csv")	
array_datasets.append(dataset)

...
for value in list_properties:
	dataset = pd.read_csv(path_to_Data+value+"/clustering_correlation_distance.csv")	
	array_datasets.append(dataset)
	dataset = pd.read_csv(path_to_Data+value+"/clustering_cosine_distance.csv")	
	array_datasets.append(dataset)
	dataset = pd.read_csv(path_to_Data+value+"/clustering_mahalonobis_distance.csv")	
	array_datasets.append(dataset)
